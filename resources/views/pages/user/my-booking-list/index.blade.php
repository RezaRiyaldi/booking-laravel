...
@section('content')
    ...
    @component('components.datatables')
        @slot('buttons')
            <a href="{{ route('my-booking-list.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Booking
                Ruangan</a>
            <a href="{{ route('my-booking-list.create-cars') }}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Booking
                Mobil</a>
        @endslot
...
@push('after-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#my-booking-list-table tbody').on('click', 'button.toggle-details', function() {
                var tr = $(this).closest('tr');
                var row = $('#my-booking-list-table').DataTable().row(tr);
